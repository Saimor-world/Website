...
describe('YORI product origin', () => {
  ...
  it.each(['javascript:alert(1)', 'https://user:secret@example.com', 'https://example.com/path', 'https://example.com?x=1', 'https://example.com#fragment', '//example.com'])('rejects unsafe/non-origin input %s', value => {

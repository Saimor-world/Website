...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.matomo.cloud https://saimorworld.matomo.cloud https://js.hcaptcha.com https://vercel.live",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "img-src 'self' data: https: blob:",
    "font-src 'self' data: https://fonts.gstatic.com",
    "connect-src 'self' https://cal.com https://api.cal.com https://saimorworld.matomo.cloud https://vitals.vercel-insights.com https://api.saimor.world https://hcaptcha.com https://api.anthropic.com https://vercel.live wss://vercel.live",

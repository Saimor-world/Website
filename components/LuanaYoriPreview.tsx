  ...
  return (
    <main className="relative overflow-hidden bg-[#efe9dc] text-[#18362b] selection:bg-[#7b8d6a]/25">
      ...
      <section className="relative overflow-hidden bg-[#0d241b] px-5 py-20 text-[#f3ecde] sm:px-9 sm:py-24 lg:px-14 lg:py-28">
        ...
        <footer className="relative z-10 mx-auto mt-20 flex max-w-[1180px] items-center justify-between border-t border-[#efe5d1]/8 pt-6 font-mono text-[6px] uppercase tracking-[.17em] text-[#e5dac3]/24 sm:text-[7px]">

  ...
  return (
    <main className="min-h-[100svh] overflow-hidden bg-[#f4edde] text-[#203128]">
      <section className="relative min-h-[100svh]">
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-0 h-[48svh] bg-cover bg-center sm:h-[52svh] lg:inset-y-0 lg:left-auto lg:right-0 lg:h-auto lg:w-[58%]"
          style={{ backgroundImage: 'url("/world/luana/room-desk.webp")' }}
        />
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-0 h-[48svh] bg-[linear-gradient(180deg,rgba(244,237,222,.02)_0%,rgba(244,237,222,.20)_58%,#f4edde_100%)] sm:h-[52svh] lg:inset-y-0 lg:left-auto lg:right-0 lg:h-auto lg:w-[64%] lg:bg-[linear-gradient(90deg,#f4edde_0%,rgba(244,237,222,.78)_14%,rgba(244,237,222,.18)_50%,rgba(244,237,222,.06)_100%)]"
        />
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] w-[calc(100%-32px)] max-w-[1240px] flex-col sm:w-[calc(100%-56px)]">
          ...
          <div className="grid flex-1 items-end gap-8 pb-7 pt-[31svh] sm:pt-[34svh] lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-16 lg:pb-10 lg:pt-10">
            <div className="max-w-[650px] lg:py-10">
              ...
              <h1 className="mt-4 max-w-[12ch] font-serif text-[clamp(2.75rem,6vw,5.5rem)] font-light leading-[.93] tracking-[-.04em] text-[#1f3028]">
              ...
              <p className="mt-5 max-w-[590px] text-[15px] leading-7 text-[#42594c] sm:text-[16px]">
                Deine Arbeit lebt heute in vielen guten Werkzeugen. YORI soll sie nicht ersetzen. Es soll erinnern, was zusammengehört, und dir den nächsten Faden zurückgeben, ohne dass du alles neu erklären musst.
              </p>
              ...
              <div className="mt-7 max-w-[610px]">
                ...
                <p className="mt-2 text-[10px] leading-5 text-[#63756a]">
                  Genannt heißt nicht verbunden. Aktiv wird eine Quelle erst, wenn du sie in YORI selbst freigibst.
                </p>
              </div>
            </div>
            ...
            <div className="lg:justify-self-end lg:w-full lg:max-w-[480px]">
              <section className="relative overflow-hidden border border-[#b49a66]/30 bg-[#fffaf0]/95 p-5 shadow-[0_24px_70px_rgba(63,48,24,.12)] backdrop-blur-md sm:p-7">
                ...
                <label className="mt-5 flex items-center border-b border-[#b49a66]/32 pb-2">
                ...
                >
                  <span>
                    ...
                    <b className="mt-1 block font-serif text-[22px] font-light text-[#263a2f]">
                ...
                >
                  Echte Konten später in YORI verbinden
                </a>
              </section>
            </div>
          </div>

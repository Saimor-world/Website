    ...
    <main className="min-h-[100svh] overflow-hidden bg-[#f4edde] text-[#203128]">
      <section className="relative min-h-[100svh]">
        ...
        {/*
          ...
          (Wortmarke 1,15:1). Statt die Schrift aufzuhellen bekommen die beiden
          Baender randlos Creme untergelegt: der Raum bleibt sichtbar, der Text
          bekommt Grund. Randlos, damit keine Panel-Kante im Bild steht.
        */}
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-0 h-[112px] bg-[linear-gradient(180deg,rgba(244,237,222,.99)_0%,rgba(244,237,222,.97)_54%,rgba(244,237,222,0)_100%)] sm:h-[124px]"
        />
        <div
          aria-hidden="true"
          className="absolute inset-x-0 bottom-0 h-[128px] bg-[linear-gradient(0deg,rgba(244,237,222,.99)_0%,rgba(244,237,222,.985)_48%,rgba(244,237,222,0)_100%)]"
        />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-serif text-[17px] tracking-[.11em] text-[#203128]">
                  LUANA <span className="text-[#83612b]">LUMINA</span>
                </p>
                <p className="mt-0.5 text-[8px] uppercase tracking-[.16em] text-[#576a5f]">deine World</p>
              </div>
            </div>
          ...
          <div className="grid flex-1 items-end gap-8 pb-7 pt-[29svh] sm:pt-[32svh] lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-16 lg:pb-10 lg:pt-10">
            <div className="min-w-0 max-w-[650px] lg:py-10">
              ...
              <div className="mt-7 max-w-[610px]">
                ...
                <p className="mt-2 text-[10px] leading-5 text-[#5c6c62]">
              ...
              <section className="relative overflow-hidden border border-[#b49a66]/30 bg-[#fffaf0]/95 p-5 shadow-[0_24px_70px_rgba(63,48,24,.12)] backdrop-blur-md sm:p-7">
                    ...
                    <button
                      ...
                      className={`border-b-2 pb-2 text-[10px] uppercase tracking-[.14em] transition ${
                        platform === item
                          ...
                          : 'border-transparent text-[#66726a]'
                      }`}
                    >
                ...
                <label className="mt-5 flex min-w-0 items-center border-b border-[#b49a66]/32 pb-2">
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 bg-transparent font-serif text-[27px] text-[#22362b] outline-none placeholder:text-[#7b8a80]"
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2">
                {LIVE_YORI.map(([label, state]) => (
                  <span key={label} className="inline-flex items-baseline gap-1.5">
                    ...
                    <small className="text-[8px] text-[#5c6a61]">{state}</small>
                  </span>
                ))}
              </div>
              <p className="text-[8px] uppercase tracking-[.16em] text-[#79633b]">

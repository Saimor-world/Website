...
const COPY: Record<Props["locale"], ProductSectionCopy> = {
  de: {
    ...
    body: "Abteilungen werden zu Räumen, Vorgänge bleiben an ihrem Platz und Môra verbindet den vorhandenen Kontext. Das OS befindet sich im aktiven Aufbau; die öffentliche Demo zeigt einen getrennten Beispiel-Arbeitsbereich.",
    trust: "Eigene Instanz und eigener Datenraum. Externe KI-Modelle können transparent angebunden werden, ohne daraus einen gemeinsamen Kundenspeicher zu machen.",
    primary: "OS öffnen",
  ...
  en: {
    ...
    body: "Departments become rooms, work stays in place and Môra connects the available context. The OS is in active development; the public demo opens a separate sample workspace.",
    trust: "A dedicated instance and data space. External AI models can be connected transparently without creating shared customer storage.",
    primary: "Open the OS",

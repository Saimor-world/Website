          ...
          <div className="space-y-9 sm:space-y-12">
            ...
            <div className="space-y-8">
              <motion.a 
                ...
                whileHover={{ x: 10 }}
              >
                <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-world-gold transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 sm:space-y-8 sm:rounded-[2.5rem] sm:p-10 sm:backdrop-blur-3xl">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-world-gold/50 transition-colors resize-none"
                />
              </div>

...
const COPY: Record<Props["locale"], ProductSectionCopy> = {
  de: {
    ...
    body: "Mail, Termine, Rechnungen, offene Vorgänge — Môra sieht alles, was auf deinem Server liegt, und legt dir morgens vor, was heute zählt. Kein Betriebssystem, kein Umzug, kein Schulungstag.",
    trust: "Deine Daten liegen auf deinem Server. Was Môra liest, verlässt dein Haus nicht.",
    primary: "Desk öffnen",
    primaryHref: "https://dash.saimor.world",
  ...
  en: {
    ...
    body: "Mail, calendar, invoices, open work — Môra sees everything on your server and lays out what matters today. No operating system to adopt, no migration, no training day.",
    trust: "Your data stays on your server. What Môra reads never leaves your house.",
    primary: "Open Desk",
    primaryHref: "https://dash.saimor.world",

...
export default function OrbitPageEN() {
  const benefits = [
    { icon: Target, text: 'Regular orientation instead of meeting overload', color: '#4A6741' },
    { icon: Heart, text: 'Depth instead of rush', color: '#5D7C54' },
    { icon: Sparkles, text: 'Continuity in change', color: '#D4B483' }
  ];
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #FAF0E6 0%, #F8F5F0 50%, #FAF0E6 100%)' }}>
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-24 text-center z-10">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-8"
              ...
              Systematic guidance for recurring transformation. A natural rhythm that creates clarity and resonance.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-20 sm:py-32 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 relative z-10">
          ...
          >
            {[
              { icon: Clock, title: 'Duration', desc: '1–6 months' },
              { icon: Repeat, title: 'Sessions', desc: 'Regular rhythm' },
              { icon: Users, title: 'Target audience', desc: 'Teams, organizations, leadership circles' }
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          >
            ...
            <p className="text-2xl sm:text-3xl font-medium text-slate-900 leading-relaxed"
              ...
              First understand, then change – <br className="hidden sm:block"/>
              Orbit creates a reliable <span className="text-saimor-green font-bold">resonance space</span> for decisions.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
            ...
            >
              ...
              />
              <span className="relative z-10">Book clarity call for Orbit</span>
            </motion.a>

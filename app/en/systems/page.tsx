...
export default function SystemsPageEN() {
  const benefits = [
    { icon: Database, text: 'Understandable data solutions', color: '#4A6741' },
    { icon: TrendingUp, text: 'Aggregated insights instead of overload', color: '#5D7C54' },
    { icon: Shield, text: 'Decisions with confidence', color: '#D4B483' }
  ];
  ...
  const packages = [
    {
      ...
      color: '#8BB581',
      description: 'Compact & clear – the most important metrics at a glance'
    },
    {
      name: 'Horizon',
      icon: BarChart3,
      ...
      color: '#4A6741',
      description: 'Weekly orientation for continuous improvement'
    },
    {
      name: 'Solara',
      icon: Activity,
      kpis: '12+ KPIs',
      frequency: 'Daily insights with action recommendations',
      color: '#D4B483',
      description: 'Comprehensive transparency with AI-powered recommendations'
    }
  ];
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-24 text-center z-10">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-8"
              ...
              Systems connects data, dashboards & AI – always human-centered.<br/>
        ...
        <div className="mx-auto max-w-5xl px-6 relative z-10">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                  Data Protection: GDPR Guardrails
                </h3>
              </div>
              ...
              <div className="max-w-3xl mx-auto">
                <ul className="space-y-3 text-lg text-slate-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Exclusively aggregated business data</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-saimor-green mt-2 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-saimor-green mt-2 flex-shrink-0" />
                    <span>Minimum group size of 5 – no personal profiles</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
            ...
            >
              ...
              />
              <span className="relative z-10">Get insight into Systems</span>
            </motion.a>

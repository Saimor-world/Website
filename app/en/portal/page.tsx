...
export const metadata = {
  title: 'SaimÃ´r Portal â€“ Calm Access (Demo)',
  description: 'UI shell for the upcoming customer portal â€“ no login yet, but guided areas, dashboard shell and trust room already exist.'
};
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-24 space-y-16">
          <header className="space-y-6 text-center">
            ...
            <p className="text-base sm:text-lg text-white/85 max-w-3xl mx-auto leading-relaxed">
              Login is still disabled â€“ but the structure is ready. Here we show how the portal will work and how todayâ€™s demo shell already links the same data.
            </p>

...
export default function PulsePageEN() {
  const benefits = [
    'Energy & focus in change situations',
    'Targeted clarification instead of continuous stress',
    'Resonance spaces for teams & regions'
  ];

  const formats = [
    {
      name: 'Workshop "Clarity in Change"',
      duration: '3h',
      icon: Target
    },
    {
      name: 'Keynote "Resonance instead of Noise"',
      duration: '30–45 min',
      icon: Zap
    },
    {
      name: 'Silent Format "The Silent Language of Depth"',
      duration: '60–90 min',
      icon: Heart
    }
  ];
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-20 text-center z-10">
          ...
          >
            ...
            >
              Pulse – Impulses for Clarity in the Moment
            </h1>
            <p className="text-xl sm:text-2xl text-white/90 leading-relaxed max-w-3xl mx-auto">
              Pulse are targeted impulse formats: Workshops, keynotes or silent spaces. They bring clarity exactly where it is needed.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          >
            <p className="text-xl sm:text-2xl font-medium text-slate-800" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              Pulse creates impulses – tangible, understandable, effective.
            </p>
          </motion.div>

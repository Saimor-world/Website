...
export const metadata = {
  title: "Saimôr Demo – Live Môra Dashboard erleben",
  description: "Erlebe Môra live: Semantische Analyse, Echtzeit-Daten und intuitive Dashboards. Kostenlose Demo für Unternehmen."
};
      ...
      <section id="demo" className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-center bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-3xl p-12 border border-emerald-500/20"
          >
            <h3 className="text-3xl font-semibold mb-4 text-white">Bereit für die Demo?</h3>
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Erlebe Môra live. Kein Verkaufsgespräch – nur eine ehrliche Demonstration
              dessen, was heute schon möglich ist.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="#demo"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-bold hover:shadow-lg hover:shadow-emerald-500/25 transition-all"
              >
                <Play className="w-5 h-5" />
      ...
      <section className="pb-24">
        <div className="mx-auto max-w-7xl px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-3xl p-8"
          >
